...
int* get_idf(map<string,int> vocabulario, string * nota1, string * nota2, string * nota3, string * nota4,string * nota5){
    ...
    cout << "chegoooouuu até aqui 3 ..." << endl;
    
    while(fgets(c,20,fp) != NULL){
        
        cout << "chegoooouuu até aqui 3.1 ..." << endl;
        ...
        cout << "chegoooouuu até aqui 3.2 ..." << endl;
        ...
        cout << "chegoooouuu até aqui 3.3 ..." << endl;
    ...
    cout << "chegoooouuu até aqui 3.9999 ..." << endl;

    fclose(fp);

    cout << "chegoooouuu até aqui 4 ..." << endl;

    idf = calcula_idf(nDocumentos);

    cout << "chegoooouuu até aqui 5 ..." << endl;
