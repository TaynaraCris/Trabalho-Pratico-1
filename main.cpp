...
int main(){
    ...
    bool vocab = false;     // Variavel para verificar triação de vocabulário
    string arqv;            // Nome do arquivo a ser lido para o projeto
    ...
    while (opcao!=5){
        ...
        switch (opcao) {
            ...
            case 2:
            {
                ...
                if (!arq_lido){
                    cout << "É PRECISO LER O ARQUIVO INICIALMENTE PELA OPÇÃO (1 - Ler o dataset do arquivo.)\n" << endl;
                    break;
                }

                cout << "gerando vocabulário ..." << endl;
                ...
                // tentativa de finalizar o projeto está parte só executava em windons por algum montivo
            ...
            case 3:
            {
                ...
                if (!vocab){
                    cout << "É PRECISO GERAR O VOCABULÁRIO INICIALMENTE PELA OPÇÃO => (2 - Gerar Vocabulário)\n" << endl;
                    break;
                }

                cout << "### Não conseguimos implementar esta funcionalidade ao projeto... ###\n" << endl;
            ...
            case 4:
            {
                ...
                if (!vocab){
                    cout << "\nÉ PRECISO GERAR O VOCABULÁRIO INICIALMENTE PELA OPÇÃO => (2 - Gerar Vocabulário)\n" << endl;
                    break;
                }
