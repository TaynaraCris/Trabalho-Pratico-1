...
int menu(){
    ...
    int opcao = 5; // opção de escolha do menu
    ...
    switch(opcao){
        case 1:
            ...
            system("clear||cls");
            cout << "================== Ler o daraset do arquivo ==================\n" << endl;
            return 1;
        case 2:
            // Gerar o vocabulário
            system("clear||cls");
            cout << "==================== Gerando Vocabulário =====================\n" << endl;
            cout << "Ainda precisamos encapsular essa funcionalidade em uma função separada..." << endl;
            break;
        case 3:
            //exibir tabela total
            system("clear||cls");
...
int main(){
    ...
    cout << "Chegou até o final normal do programa veeeeiii" << endl;
